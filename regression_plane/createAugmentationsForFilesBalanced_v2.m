...
outFolder = fullfile(baseFolder,'trainBalAug/images/');
outRegFolder = fullfile(baseFolder,'trainBalAug/labels/');
...
%%
density = load('./data/zero_padded_section_density.mat'); % TODO should redo it for renamed files
