function augmentTrainingSetRegression(inFolder, outFolder, regFolder, outRegFolder, styleData, multiplyAugment)
%%%
...
for i=1:stepSize:numel(fileList)
    ...
    [folder, fname, ext] = fileparts(fileList(i).name);
    fileRegName = fullfile(regFolder, [fname, '.tif']);
    ...
    for j=1:numAugment
        ...
        imwrite(regImg, [outRegFolder filesep outName '.tif']); 
    end
end
