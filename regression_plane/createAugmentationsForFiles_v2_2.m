...
baseFolder = '/home/koosk/images-data/2022_v1_zeroPadded_split';

inFolder = fullfile(baseFolder,'train/images/');
regFolder = fullfile(baseFolder,'train/labels/');

outFolder = fullfile(baseFolder,'trainAugOld/images/');
outRegFolder = fullfile(baseFolder,'trainAugOld/labels/');

% inFolder = fullfile(baseFolder,'split_traj/train/images/');
% regFolder = fullfile(baseFolder,'split_traj/train/labels/');
% 
% outFolder = fullfile(baseFolder,'split_traj/trainAug/images/');
% outRegFolder = fullfile(baseFolder,'split_traj/trainAug/labels/');
%%
mkdir(outFolder);
mkdir(outRegFolder);
...
%     fileRegName = [regFolder fname];
    ...
    imwrite(inImg, [outFolder, basename, '.png']);
